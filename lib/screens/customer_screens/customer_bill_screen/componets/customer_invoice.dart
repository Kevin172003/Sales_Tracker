...
class CustomerInvoiceScreen extends StatefulWidget {
  ...
  CustomerInvoiceScreen({super.key, required this.orderId});
  ...
  pw.Column _buildInvoiceDetails() {
    return pw.Column(
      ...
      children: [
          ...
          children: [
            ...
            pw.ListView.builder(
              ...
              itemBuilder: (context, index) {
                var subProduct_id = orderDataDetails[index]['sub_product'];
        ...
        pw.Padding(
          padding: pw.EdgeInsets.fromLTRB(265, 0, 0, 0),
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            Text(
                              orderData.isNotEmpty ? orderData[0]['order_date'] : '',
                            )
                          ],
                        ),
                      ],
